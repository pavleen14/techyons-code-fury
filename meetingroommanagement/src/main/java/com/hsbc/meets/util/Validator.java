...
public class Validator {
	...
	/**
	 * Checks if password matches given criteria: 1. At least one upper case
	 * alphabet 2. At least one lower case alphabet 3. At least one digit 4. At
	 * least one secial character - allowed special characters: @, #, $, %, ^, &, -,
